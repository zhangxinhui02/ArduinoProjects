...
//          尾灯(LED)：左：11 右：12
//          蜂鸣器(Buzzer)：6
//          超声波(CH)：echo：4 trig：5
//          GPS：rx：2 tx：3
//          蓝牙：tx:0 rx:1
//          加速度：CS:3V3 SDO:GND SDA:A4 SCL:A5

//注：本程序部分代码参考了CSDN acktomas 翻译的内容，并借鉴了其提供的示例代码。
//CSDN： https://blog.csdn.net/acktomas/article/details/88870325 
//Sparkfun: https://learn.sparkfun.com/tutorials/adxl345-hookup-guide 
...
//延时2s获取GPS的数据（返回格式weidu+"#"+weidubq+"#"+jingdu+"#"+jingdubq）
String GetGPS(){
  long timeout=2000+millis();
  String GPSstr="";
